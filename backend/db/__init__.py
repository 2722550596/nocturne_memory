...
def _ensure_initialized():
    global _db_manager, _graph_service, _search_indexer, _glossary_service, _preset_service, _embedding_service
    ...
    _embedding_service = EmbeddingService(_db_manager)
    _search_indexer = SearchIndexer(_db_manager, embedding_service=_embedding_service)
...
__all__ = [
    ...
    "get_preset_service", "get_embedding_service",
    "close_db",
    "hot_swap_database",
    "ChangesetStore", "get_changeset_store",
    "get_namespace", "set_namespace",
    "GlossaryKeyword", "SearchDocument", "SearchDocumentEmbedding",
    "ChangeCollector", "Preset", "Revision",
]
